...
- [Использование](#использование)
    ...
    - [2. Настройте и инициализируйте](#2-настройте-и-инициализируйте)
      - [Внедрение в поля (Опционально)](#внедрение-в-поля-опционально)
...
#### Внедрение в поля (Опционально)

Хотя внедрение через конструктор рекомендуется, Dimension-DI также поддерживает внедрение в поля для гибкости:
...
Примечание: Внедрение в поля происходит после создания объекта. Final поля не могут быть внедрены.
...
- Выполняет внедрение в поля после конструирования (поддерживает `@Inject` на полях, включая квалификаторы `@Named`)
...
| Тип внедрения зависимостей   | Конструктор, Поля                    | Конструктор, поле, метод               | Конструктор, поле, метод    | На основе конструктора    |
...
| Внедрение в методы           | ❌ Нет                                | ✅ Да                                   | ✅ Да                        | ✅ Да (members injection)  |
